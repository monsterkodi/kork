...
class Debug
{
    constructor ()
    {
        ...
        this.button({text:'camera',parent:this.tool,click:function ()
        {
            return rts.resetCamera()
        }})
        this.button({text:'front',parent:this.tool,click:function ()
        {
            return rts.resetCamera('front')
        }})
        this.button({text:'side',parent:this.tool,click:function ()
        {
            return rts.resetCamera('side')
        }})
        this.button({text:'top',parent:this.tool,click:function ()
        {
            return rts.resetCamera('top')
        }})
    ...
    button (cfg)
    {
        ...
        return elem({class:'btn',text:cfg.text,click:cfg.click,parent:((_93_88_=cfg.parent) != null ? _93_88_ : this.elem)})
    }
    ...
    toggle (cfg)
    {
        ...
        btn = elem({class:'btn',text:cfg.text,click:tgl(cfg),parent:((_120_80_=cfg.parent) != null ? _120_80_ : this.elem)})
        if (_k_.isFunc(cfg.get))
        {
            val = cfg.get()
        }
